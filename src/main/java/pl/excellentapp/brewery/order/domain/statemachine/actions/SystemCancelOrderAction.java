...
class SystemCancelOrderAction extends AbstractAction {
    ...
    public SystemCancelOrderAction(OrderRepository beerOrderRepository, JmsTemplate jmsTemplate, @Value("${queue.inventory.deallocate-stock}") String deallocateOrderQueueName) {
